...
public class Vinapho extends AppCompatActivity {

    private Button btnPedidoVinapho;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vinapho);
        ...
        btnPedidoVinapho =(Button) findViewById(R.id.btnPedidoVinapho);
