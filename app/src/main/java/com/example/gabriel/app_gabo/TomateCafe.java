...
public class TomateCafe extends AppCompatActivity {

    private Button btnPedidoTomateCafe;
    private Button btnTomateCafepagina;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tomatecafe);
        ...
        btnPedidoTomateCafe =(Button) findViewById(R.id.btnPedidoCasadeSol);
        btnTomateCafepagina =(Button) findViewById(R.id.btnTomateCafepagina);


        btnTomateCafepagina.setOnClickListener(new View.OnClickListener() {
            @Override
